	...
	tinymce.create('tinymce.plugins.SpringbokGallery', {
		...
		init : function(ed, url) {
			...
			ed.addCommand('springbokGallery', function() {
				gallery.setOnSelectImage(function(idImage,image){ed.execCommand('mceInsertContent', false,'<img src="'+webdir+'files/images/'+idImage+'.jpg" width="'+image.width+'" height="'+image.height+'" />');gallery.close();});
				gallery.load(true);
			});
